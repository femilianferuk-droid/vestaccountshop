...
# Инициализация и накат структуры
...
def index():
    ...
    <div class="text-center py-6">
        ...
        <p class="text-slate-400 text-sm max-w-xl mx-auto mb-8">
            Чистые прокси при регистрации. Автоматическая выдача ZIP-архивов форматов tdata / .session.
        </p>
    </div>
...
def invoice_view(inv, amount_rub):
    ...
    <div class="glass p-8 rounded-2xl text-center max-w-md mx-auto">
        ...
        <form action="/check_invoice/{{ inv.id }}" method="POST">
            ...
            <button type="submit" class="w-full py-3 bg-white/5 border border-white/10 hover:bg-white/10 text-white font-bold text-xs uppercase rounded-xl">Проверить зачисление</button>
        </form>
    </div>
    """
        ...
        <div class="glass p-6 rounded-xl">
            ...
            <form action="/admin/add_account" method="POST" class="space-y-4">
                <div>
                    ...
                    <select name="category" class="w-full p-3 bg-slate-950 border border-white/10 rounded-xl text-white">
